...
inputs(counts2sce)
counts2sce$dirname <- file.path("~/workspace/STARsolo_output/Solo.out")
...
```{r}
inputs(STARsolo2sce)
STARsolo2sce$readFilesIn_cdna <- cdna.fastq
STARsolo2sce$readFilesIn_cb <- cb.fastq
STARsolo2sce$whiteList <- cblist
STARsolo2sce$genomeDir <- "~/workspace/STARindex_output"
